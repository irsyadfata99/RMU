  ...
  const cardData = [
    {
      ...
      features: [
        "9 Bulan program (36 pertemuan)",
        "Project based curriculum",
        "6 hingga 10 siswa per kelas",
    ...
    },
    {
      ...
      features: [
        "9 Bulan program (36 pertemuan)",
        "Online atau offline class",
        "maximal 6 siswa per kelas",
        "Sertifikat dan portfolio",
      ],
  ...
  return (
    ...
    >
          ...
          return (
            <motion.div
              ...
              className={`relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group ${
                card.isActive
                  ? "transform scale-105 ring-4 ring-[#00B5AD] ring-opacity-50"
                  : "hover:scale-105"
              }`}
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              <div className="relative bg-white dark:bg-gray-800 p-8 h-full flex flex-col">
                ...
                <div className="mb-6 flex justify-center">
                  <div
                    className="w-16 h-16 rounded-full flex items-center justify-center shadow-lg p-3"
                ...
                <button
                  className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 ${
                    card.isActive
                      ? "bg-[#00B5AD] text-white hover:bg-[#00948e] shadow-lg hover:shadow-xl"
                      : "bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                  }`}
                  onClick={() =>
                    window.open("https://wa.me/6285691655307", "_blank")
                  }
                >
                  {card.isActive
                ...
                {/* Active Badge */}
                {card.isActive && (
                  <div className="absolute top-4 right-4 bg-[#00B5AD] text-white px-3 py-1 rounded-full text-xs font-semibold">
                    Populer
                  </div>
                )}
              </div>
      ...
      >
        ...
        <button
          className="bg-gradient-to-r from-[#00B5AD] to-[#00948e] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
