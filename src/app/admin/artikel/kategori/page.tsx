...
import {Category,PaginationMeta,getCategories,deleteCategory} from "@/lib/api/kategori";
...
const CategoryPage = () => {
  ...
  const [isDeleting, setIsDeleting] = useState(false);
   ...
   const [editingTag, setEditingTag] = useState<Category | null>(null);
    ...
    return (
      <div className="space-y-6">
        ...
        <CategoryModal
          ...
          onSuccess={() => fetchCategories(page)}
        />
      </div>
  );
};
